...
# Default bucket name is intentionally a placeholder for the public repo.
DEFAULT_GCS_BUCKET = "your-gcs-bucket"
DEFAULT_GCS_BASE_PATH = "Dataset"

# Dataset file paths (relative to base path)
GCS_DATASET_PATHS = {
    # Processed data ready for the pipeline
    "movies_vector_ready": "graph_rag_outputs/movies_vector_ready.csv",
    "user_emotion_profiles": "graph_rag_outputs/user_emotion_profiles.csv",
    "user_emotion_sensitivities": "graph_rag_outputs/user_emotion_sensitivities.csv",
    
    # Neo4j graph exports
    "neo4j_nodes_movies": "graph_rag_outputs/neo4j_nodes/movies.csv",
    "neo4j_nodes_emotions": "graph_rag_outputs/neo4j_nodes/emotions.csv",
    "neo4j_nodes_genres": "graph_rag_outputs/neo4j_nodes/genres.csv",
    "neo4j_nodes_users": "graph_rag_outputs/neo4j_nodes/users.csv",
    
    # Neo4j relationships
    "neo4j_rel_movie_genre": "graph_rag_outputs/neo4j_relationships/movie_belongs_to_genre.csv",
    "neo4j_rel_movie_emotion": "graph_rag_outputs/neo4j_relationships/movie_expresses_emotion.csv",
    "neo4j_rel_movie_similar": "graph_rag_outputs/neo4j_relationships/movie_similar_emotions.csv",
    "neo4j_rel_user_emotion": "graph_rag_outputs/neo4j_relationships/user_prefers_emotion.csv",
    "neo4j_rel_user_rating": "graph_rag_outputs/neo4j_relationships/user_rated_movie.csv",
    
    # Raw MovieLens data
    "ratings": "ratings.csv",
    "movies_raw": "movies.csv",
    "movies_final": "movies_final.csv",
    "tags": "tags.csv",
    "links": "links.csv",
    "genome_scores": "genome-scores.csv",
    "genome_tags": "genome-tags.csv",
    "emotion_dataset": "Emotion_Dataset.csv",
}
