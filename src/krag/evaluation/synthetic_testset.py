...
class SyntheticTestSetGenerator:
    ...
    Uses narrative natural-language intents plus target affective vectors.
    Relevance is defined by semantic and affective similarity thresholds.
    """
    ...
    def generate_dissonance_queries(
        ...
        These scenarios intentionally pair conflicting topic/emotion intents
        (for example, "a happy movie about war").
...
class LOOCVTestCase:
    """
    LOOCV test case for interaction-history evaluation.
...
class LOOCVTestSetGenerator:
    ...
    For each user sequence, the final item is treated as ground truth and the
    preceding history is used as context.
    """
