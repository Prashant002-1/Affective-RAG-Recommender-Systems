...
Queries a large language model directly with user context and target emotions.
This baseline does not use external retrieval and relies on model parametric
knowledge only.
"""
